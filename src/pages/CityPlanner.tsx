    ...
    <section className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
      <div className="grid gap-5 lg:grid-cols-[1.05fr_.95fr]">
        ...
        <div className="sanskriti-card rounded-3xl border border-stoneline p-6 shadow-sm sm:p-8">
          ...
          <div className="mt-5 rounded-2xl bg-ink p-5 text-white"><p className="text-xs font-bold uppercase tracking-wide text-marigold">Why this route</p><p className="mt-2 text-sm leading-6 text-white/70">Your route prioritises the destination's available cultural information while keeping the journey simple and theme-consistent.</p></div>
        </div>
      </div>
