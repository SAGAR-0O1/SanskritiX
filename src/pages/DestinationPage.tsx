...
export default function DestinationPage() {
  ...
  return (
    <div>
      ...
      <Section title="Travel Essentials" subtitle={`Plan your visit to ${destination.name} with transport, fair-price, food, stay and seasonal guidance.`}>
        <TravelEssentials cityId={destination.id} cityName={destination.name} />
      </Section>
